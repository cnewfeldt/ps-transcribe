...
- **After every task commit:** Run `cd PSTranscribe && swift test --filter OllamaServiceTests`
...
| 05-02-01 | 02 | 2 | OLMA-04 | unit | `swift test --filter AppSettingsTests` | ❌ W0 | ⬜ pending |
...
- [ ] `PSTranscribe/Tests/PSTranscribeTests/OllamaServiceTests.swift` -- stubs for OLMA-01, OLMA-03, OLMA-05, OLMA-06
- [ ] JSON fixture data for OllamaTagsResponse decode test
- [ ] `PSTranscribe/Tests/PSTranscribeTests/AppSettingsOllamaTests.swift` -- selectedOllamaModel persistence
