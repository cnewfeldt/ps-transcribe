...
- [ ] **SECR-06**: Transcript and session files created with restrictive file permissions (SCAN-006)
...
- [ ] **SESS-02**: Each library entry shows recording name, date, duration, and file status
- [ ] **SESS-03**: Clicking a library entry loads the transcript content in the app
- [ ] **SESS-04**: Each library entry has a clickable file path to the transcript on disk
- [ ] **SESS-05**: Library entries show "missing" indicator if transcript file has been moved or deleted
...
- [ ] **SESS-09**: Session index persists across app restarts
...
- [ ] **NAME-04**: Unnamed recordings fall back to date-based filename
