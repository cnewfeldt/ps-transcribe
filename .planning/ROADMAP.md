...
- [x] 13-05-PLAN.md — page.tsx composition, production build, verify-landing green, human UAT checkpoint
**UI hint**: yes
...
### Phase 999.1: Keyboard-triggered clipboard dictation recording (BACKLOG)
