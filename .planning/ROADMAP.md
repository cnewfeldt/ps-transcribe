...
- [ ] 18-06-PLAN.md — Full begin/end/cancel flow (clipboard, library, auto-name, fallback) (Wave 4)
- [ ] 18-07-PLAN.md — Settings > Dictation section (hotkey recorder, mode picker, folder picker) (Wave 5)
...
| 18. Hotkey Dictation + Plain-Folder Output | 5/8 | In Progress|  |
