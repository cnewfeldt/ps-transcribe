...
cd "$(dirname "$0")/.."
APP_PATH="dist/PS Transcribe.app"
DMG_PATH="dist/PS Transcribe.dmg"
...
TEMP_DMG="dist/PS_Transcribe_temp.dmg"
...
hdiutil create -volname "PS Transcribe" -srcfolder "$STAGING_DIR" -ov -format UDRW "$TEMP_DMG"
...
tell application "Finder"
  tell disk "PS Transcribe"
    ...
    set position of item "PS Transcribe.app" of container window to {120, 150}
